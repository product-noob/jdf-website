      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mb-16 border-b border-white/10 pb-16">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-10 h-10 rounded-full bg-white overflow-hidden flex items-center justify-center text-white font-serif font-bold text-xl shrink-0">
                <img
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.youtube.com/@jaindostifederation" aria-label="Jain Dosti Federation on YouTube" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white/70 hover:bg-primary hover:text-white transition-colors">
                <Youtube size={18} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-white/60 text-sm">namaste@jdfindia.org</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/40">
          ...
          <div className="flex gap-6">
            <a href={`mailto:namaste@jdfindia.org?subject=${encodeURIComponent(t.footer.privacyPolicy)}`} className="hover:text-white transition-colors">{t.footer.privacyPolicy}</a>
            <a href={`mailto:namaste@jdfindia.org?subject=${encodeURIComponent(t.footer.termsOfService)}`} className="hover:text-white transition-colors">{t.footer.termsOfService}</a>
          </div>
        </div>
      </div>
    </footer>
