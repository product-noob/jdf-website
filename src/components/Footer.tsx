        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16 border-b border-white/10 pb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#about" className="text-white/60 hover:text-primary transition-colors text-sm">{t.footer.aboutUs}</a></li>
              <li><a href="#tours" className="text-white/60 hover:text-primary transition-colors text-sm">{t.footer.upcomingYatras}</a></li>
              <li><a href="#seva" className="text-white/60 hover:text-primary transition-colors text-sm">{t.footer.philanthropyProjects}</a></li>
              <li><a href="#" className="text-white/60 hover:text-primary transition-colors text-sm">{t.footer.memberDirectory}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-white/60 hover:text-primary transition-colors text-sm">{t.footer.downloadItineraries}</a></li>
              <li><a href="#" className="text-white/60 hover:text-primary transition-colors text-sm">{t.footer.volunteerGuidelines}</a></li>
              <li><a href="#" className="text-white/60 hover:text-primary transition-colors text-sm">{t.footer.donationFaqs}</a></li>
              <li><a href="#" className="text-white/60 hover:text-primary transition-colors text-sm">{t.footer.safetyProtocols}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-white/60 text-sm">namaste@jaindostifederation.org</span>
              </li>
            </ul>
          </div>
        </div>
